#' Data Create
#'
#' @param raw = FALSE, if you would like a "data-raw" folder, specify TRUE
#' @param cleaned = FALSE if you woud like a "data-cleaned" folder, specify TRUE
#'
#' @return
#' @export
